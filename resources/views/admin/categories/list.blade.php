    ...
    <div class="main-content">
        <div class="panel mb25">
            <div class="panel-body">
                <form method="get" action="{{ route('admin-categories') }}" name="search-action-frm">
                    ...
                    <div class="row">
                        ...
                        <div class="panel mb-3 col-sm-12">
                            <a id="new" href="{{ route('add-category') }}" class="btn btn-default mb15 ml15 mr-3"><i
                                        class="fa fa-plus fa-fw"></i>&nbsp;&nbsp;Add New&nbsp;</a>
                            <a href="{{ route('admin-categories') }}" class="btn btn-primary mb15 ml15 mr-3"><i
                                        class="fa fa-list fa-fw"></i>&nbsp;&nbsp;All ({{$all_records}})&nbsp;</a>
                            <a href="{{ route('admin-categories') }}?status=1" class="btn btn-success mb15 ml15 mr-3"><i
                                        class=" fa fa-thumbs-up text-success "></i>&nbsp;&nbsp;Active List
                                ({{$active_records}})&nbsp;</a>
                            <a href="{{ route('admin-categories') }}?status=0" class="btn btn-warning mb15 ml15 mr-3"><i
                                        class=" fa fa-thumbs-down text-warning "></i>&nbsp;&nbsp;In Active List
                                ({{$inactive_records}})&nbsp;</a>
                            <a id="action-order" href="#" class="btn btn-warning mb15 ml15"><i class="fa fa-sort"></i>  Update Order</a>
                        </div>
                        <div class="panel mb-3 col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            {!! Form::open(array('route' => array('handle-manage-bulk-categories'), 'method' => 'post', 'role' => 'form',  'class' => 'needs-validation', 'name' => 'bulk-action-frm')) !!}
                                ...
                                @if($records->total() > 0 && !empty($records))
                                    @foreach($records as $record)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-category', [$record->id]) }}"><i class="fas fa-pencil-alt"></i></a>
                                            </td>
                                            <td>
                                            ...
                                            <td><input type="text" class="form-control" style="width: 100px;" name="orders[{{$record->id}}]" value="{{$record->ordernum}}" id="orders" /></td>
                                            <td>@if($record->hide == 1) Yes @else No @endif</td>
